...
WIN64_AMD_VS2019_OSSLINC_DIR    = $(OSSL_DIR)/include
WIN64_AMD_VS2019_BUILD_OSSL     = platforms\$(OPENSSL_LIBVER)\b64_VS2019.bat $(OPENSSL_VER)
WIN64_AMD_VS2019_CLEAN_OSSL     = rm $(OSSL_DIR)/*.dll; rm $(OSSL_DIR)/*.ilk ; rm  $(OSSL_DIR)/*/*.obj;  rm $(OSSL_DIR)/*/*/*.obj ; rm openssl.c
