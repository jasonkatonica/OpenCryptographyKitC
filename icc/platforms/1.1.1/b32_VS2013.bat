...
set WK=x:\ICC8.5\win\icc
rem Build OpenSSL finally
set OSSLVER=%1
cd ..\%OSSLVER%
perl Configure VC-WIN32 no-engine no-sctp no-idea no-rc5 no-whirlpool no-zlib enable-mdc2 enable-camellia enable-md2 no-seed 
rem clear these or nmake complains later
set MAKE=
set MAKEFLAGS=
nmake /f makefile
mkdir tmp32dll
