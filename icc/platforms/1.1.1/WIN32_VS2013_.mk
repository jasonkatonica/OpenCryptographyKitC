...
ASM_OBJS = dso_win32.obj rand_win.obj  \
	cmll-x86.obj  x86-gf2m.obj  \
	aesni-x86.obj vpaes-x86.obj  \
	x86cpuid.obj  ghash-x86.obj  \
	x86-mont.obj \
	bf-586.obj bn-586.obj co-586.obj des-586.obj md5-586.obj \
	rc4-586.obj rmd-586.obj \
	sha1-586.obj sha256-586.obj sha512-586.obj \
	crypt586.obj \
	threads_win.obj async_win.obj \
	poly1305-x86.obj  \
	chacha-x86.obj \
	c_enc.obj \
	ecp_nistz256.obj ecp_nistz256-x86.obj \
	keccak1600.obj uplink.obj


WIN32_VS2013_OSSLINC_DIR    = $(OSSL_DIR)/include

WIN32_VS2013_BUILD_OSSL     = chmod +w b32.bat; cp platforms/$(OPENSSL_LIBVER)/b32_VS2013.bat b32.bat; cmd /A /D /C b32.bat $(OPENSSL_VER)


WIN32_VS2013_CLEAN_OSSL		= rm $(OSSL_DIR)/*.dll; rm $(OSSL_DIR)/*.ilk ; rm  $(OSSL_DIR)/*/*.obj;  rm $(OSSL_DIR)/*/*/*.obj ; rm openssl.c
...
#
# Objects needed to build openssl.exe
#
...
CRYPTOOBJ=	$(OBJ_D)/init.obj \
	...
	$(OBJ_D)/x86cpuid.obj $(OBJ_D)/md2_dgst.obj $(OBJ_D)/co-586.obj \
	$(OBJ_D)/md2_one.obj $(OBJ_D)/md4_dgst.obj $(OBJ_D)/md4_one.obj \
	$(OBJ_D)/md5_dgst.obj $(OBJ_D)/md5_one.obj $(OBJ_D)/md5-586.obj \
	$(OBJ_D)/sha1dgst.obj  \
	$(OBJ_D)/sha1_one.obj $(OBJ_D)/sha256.obj $(OBJ_D)/sha512.obj \
	$(OBJ_D)/sha1-586.obj $(OBJ_D)/sha256-586.obj $(OBJ_D)/sha512-586.obj \
	$(OBJ_D)/mdc2dgst.obj \
	...
	$(OBJ_D)/rc2ofb64.obj $(OBJ_D)/rc4-586.obj \
	$(OBJ_D)/bf_skey.obj $(OBJ_D)/bf_ecb.obj \
	$(OBJ_D)/bf-586.obj $(OBJ_D)/des-586.obj  \
	$(OBJ_D)/bf_cfb64.obj $(OBJ_D)/bf_ofb64.obj \
	...
	$(OBJ_D)/cmll_ctr.obj $(OBJ_D)/cmll-x86.obj \
	$(OBJ_D)/cbc128.obj $(OBJ_D)/ctr128.obj \
	$(OBJ_D)/cts128.obj $(OBJ_D)/cfb128.obj $(OBJ_D)/ofb128.obj \
	$(OBJ_D)/gcm128.obj $(OBJ_D)/ccm128.obj $(OBJ_D)/xts128.obj \
	$(OBJ_D)/wrap128.obj $(OBJ_D)/ghash-x86.obj \
	...
	$(OBJ_D)/bn-586.obj $(OBJ_D)/crypt586.obj $(OBJ_D)/rmd-586.obj \
	$(OBJ_D)/x86-mont.obj \
	...
	$(OBJ_D)/ec_oct.obj $(OBJ_D)/ecp_nistz256.obj $(OBJ_D)/ecp_nistz256-x86.obj \
	$(OBJ_D)/buffer.obj \
	...
	$(OBJ_D)/conf_ssl.obj \
	$(OBJ_D)/bio_meth.obj $(OBJ_D)/asn1_item_list.obj \
	$(OBJ_D)/ctype.obj $(OBJ_D)/ui_null.obj \
	$(OBJ_D)/drbg_lib.obj $(OBJ_D)/drbg_ctr.obj \
	$(OBJ_D)/poly1305_ameth.obj $(OBJ_D)/poly1305_pmeth.obj \
