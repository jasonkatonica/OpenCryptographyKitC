...
$(OPSYS)_OSSLINC_DIR    = $(OSSL_DIR)/include
$(OPSYS)_BUILD_OSSL     = platforms\$(OPENSSL_LIBVER)\b32_VS2022.bat $(OPENSSL_VER) $(OPENSSL_$(CONFIG)_FLAG)
$(OPSYS)_CLEAN_OSSL		= rm $(OSSL_DIR)/*.dll; rm $(OSSL_DIR)/*.ilk ; rm $(OSSL_DIR)/*/*.obj ; rm $(OSSL_DIR)/*/*/*.obj ; find . -name \*.obj -type f -delete ; rm openssl.c
