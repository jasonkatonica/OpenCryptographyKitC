...
#
# Moved to platform specific because on Linux we need to set the soname
# unarchive libcrypto.a and relink it as a
# new shared library to get the soname correct
# 
#
$(OSSLDLL):  $(MY_OSSLDLL_NAME)
