...
WIN64_AMD_OSSLINC_DIR    = $(OSSL_DIR)/include

WIN64_AMD_BUILD_OSSL     = chmod +w b64.bat; cp  platforms/$(OPENSSL_LIBVER)/b64.bat .; cmd /A /D /C b64.bat $(OPENSSL_VER)

WIN64_AMD_CLEAN_OSSL     = rm $(OSSL_DIR)/*.dll; rm $(OSSL_DIR)/*.ilk ; rm  $(OSSL_DIR)/*/*.obj;  rm $(OSSL_DIR)/*/*/*.obj ; rm openssl.c
