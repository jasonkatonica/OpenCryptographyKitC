...
WIN64_AMD_VS2013_MT             = $(WIN32_MT)

WIN64_AMD_VS2019_RM             = rm -f
WIN64_AMD_VS2019_MKDIR          = [ -d $@ ] || mkdir -p
WIN64_AMD_VS2019_CP             = cp -f
WIN64_AMD_VS2019_DEBUGGER       = msdev
WIN64_AMD_VS2019_CC             = cl
WIN64_AMD_VS2019_CXX            = cl -TP
WIN64_AMD_VS2019_debug_CFLAGS   = -MDd -Zi
WIN64_AMD_VS2019_release_CFLAGS = -MD -Zi -Ox
# warnings to errors - can cause crash on some platforms - i.e 64 bit pointers cannot be int (32 bits)
#  warning C4013: ... undefined; assuming extern returning int
#  warning C4047: ... differs in levels of indirection from 'int'
WIN64_AMD_VS2019_W_FLAGS         = -W4 -D_CRT_SECURE_NO_WARNINGS -we4047 -we4013
WIN64_AMD_VS2019_CFLAGS         = -c $(WIN64_AMD_$(CONFIG)_CFLAGS) -GS -nologo -D_AMD64_=1 -DWIN64 -D_WIN64 -DWIN32 -D_WIN32 $(WIN64_AMD_2019_W_FLAGS)
WIN64_AMD_VS2019_LD             = link
WIN64_AMD_VS2019_LD_CXX         = link
WIN64_AMD_VS2019_SLD            = $(WIN64_AMD_LD)
WIN64_AMD_VS2019_AR             = $(WIN64_AMD_LD)
WIN64_AMD_VS2019_debug_LDFLAGS  = -debug
WIN64_AMD_VS2019_LDFLAGS        = -DYNAMICBASE -NXCOMPAT -DEBUG -manifest -nologo $(WIN64_AMD_$(CONFIG)_LDFLAGS) -out:$@
WIN64_AMD_VS2019_SLDFLAGS       = -dll $(WIN64_AMD_LDFLAGS)
WIN64_AMD_VS2019_ARFLAGS        = -lib -nologo -out:$@
WIN64_AMD_VS2019_release_LDLIBS = gdi32.lib advapi32.lib user32.lib
WIN64_AMD_VS2019_debug_LDLIBS   = $(WIN64_AMD_release_LDLIBS)
WIN64_AMD_VS2019_LDLIBS         = -DYNAMICBASE -NXCOMPAT $(WIN64_AMD_$(CONFIG)_LDLIBS)
WIN64_AMD_VS2019_OBJSUFX        = .obj
WIN64_AMD_VS2019_EXESUFX        = .exe
WIN64_AMD_VS2019_SHLPRFX        =
WIN64_AMD_VS2019_SHLSUFX        = .dll
WIN64_AMD_VS2019_STLPRFX        =
WIN64_AMD_VS2019_STLSUFX        = .lib
WIN64_AMD_VS2019_debug_STRIP    = touch
WIN64_AMD_VS2019_release_STRIP  = touch
WIN64_AMD_VS2019_OUT            = $(WIN32_OUT)
WIN64_AMD_VS2019_CFLAGS2        = $(WIN64_AMD_CFLAGS)
WIN64_AMD_VS2019_LDFLAGS2       = $(WIN64_AMD_LDFLAGS)
WIN64_AMD_VS2019_SLDFLAGS2      = $(WIN64_AMD_SLDFLAGS)
WIN64_AMD_VS2019_MT             = $(WIN32_MT)
...
ZOSA31_MT  	   = true
ZOSA31_CCVERSION = $(ZOS_CCVERSION)
...
POWERH_MT	     = true
POWERH_CCVERSION = $(ZOS_CCVERSION)
...
OS400X_MT		= true
OS400X_CCVERSION = $(ZOS_CCVERSION)
