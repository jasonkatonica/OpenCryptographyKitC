...
# We need the objs for producing openssl.exe, default is used for win32 variants
DEFAULT_SLIBCRYPTO_OBJS             = $(CRYPTOOBJ)
DEFAULT_SLIBSSL_OBJS              	= $(SSLOBJ)
# Not used, but just in case there is no OS specific define
DEFAULT_SLIBCRYPTO          = $(OSSL_DIR)/libcrypto.a
DEFAULT_SLIBSSL             = $(OSSL_DIR)/libssl.a
DEFAULT_OPENSSL_LIBS 		= ws2_32.lib

$(OPSYS)_APP_DIR        	= $(DEFAULT_APP_DIR)
$(OPSYS)_LIB_DIR            = $(DEFAULT_LIB_DIR)
$(OPSYS)_SLIBCRYPTO_OBJS	= $(DEFAULT_SLIBCRYPTO_OBJS)
$(OPSYS)_SLIBCRYPTO         = $(DEFAULT_SLIBCRYPTO)
$(OPSYS)_SLIBSSL_OBJS		= $(DEFAULT_SLIBSSL_OBJS)
...
WIN64_AMD_SLIBCRYPTO_OBJS   = $(WIN64_AMD_CRYPTOOBJ)
WIN64_AMD_SLIBCRYPTO        = $(WIN_SLIBCRYPTO)
WIN64_AMD_SLIBSSL           = $(WIN_SLIBSSL)
...
WIN32_VS2022_APP_DIR		= $(WIN_APP_DIR)
WIN32_VS2022_OPENSSL_LIBS	= $(WIN_OPENSSL_LIBS)
WIN32_VS2022_SLIBCRYPTO		= $(WIN_SLIBCRYPTO)
WIN32_VS2022_SLIBSSL		= $(WIN_SLIBSSL)
...
WIN64_AMD_VS2019_APP_DIR      	= $(WIN_APP_DIR)
WIN64_AMD_VS2019_OPENSSL_LIBS 	= $(WIN_OPENSSL_LIBS)
WIN64_AMD_VS2019_SLIBCRYPTO	= $(WIN64_AMD_CRYPTOOBJ)
WIN64_AMD_VS2019_SLIBSSL	= $(SSLOBJ)

WIN64_VS2022_APP_DIR      	= $(WIN_APP_DIR)
WIN64_VS2022_OPENSSL_LIBS 	= $(WIN_OPENSSL_LIBS)
WIN64_VS2022_SLIBCRYPTO_OBJS= $(WIN64_AMD_CRYPTOOBJ)
WIN64_VS2022_SLIBCRYPTO	    = $(WIN_SLIBCRYPTO)
WIN64_VS2022_SLIBSSL	    = $(WIN_SLIBSSL)
...
SLIBCRYPTO_OBJS	= $($(OPSYS)_SLIBCRYPTO_OBJS)
SLIBCRYPTO   	= $($(OPSYS)_SLIBCRYPTO)
SLIBSSL_OBJS  	= $($(OPSYS)_SLIBSSL_OBJS)
